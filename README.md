...
- 🟢 Solved **300+ problems on LeetCode** (200+ active days)  
- 🟦 **5-Star (C++ & Python)** | HackerRank  
- 🟨 **5-Star (SQL)** | HackerRank  
- 📊 Designed **Power BI dashboards** with datasets of 6K+ records  
- 🚀 Hands-on with **Kubernetes deployments using Docker & Helm**  
...
💡 *"Consistency over Perfection"* – I believe consistent effort and curiosity lead to lasting growth and innovation.  
